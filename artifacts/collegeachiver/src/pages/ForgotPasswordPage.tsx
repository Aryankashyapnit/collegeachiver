...
export default function ForgotPasswordPage() {
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    else { setMessage({ text: 'Reset link sent! Please check your email inbox.', type: 'success' }); }
    setLoading(false);
  };
    ...
    <div className="min-h-screen bg-[#fafbfc] flex items-center justify-center p-4 font-sans selection:bg-[#fcd71a]/30">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-[#eef2f7] p-8 md:p-10 relative">
        ...
        <div className="text-center mb-10 mt-2">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#fcd71a]/10 text-[#cca01d] mb-4 shadow-sm border border-[#f5d020]/20"><HelpCircle size={28} /></div>
