  ...
  return (
    <main className="max-w-xl mx-auto px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white border border-zinc-200 p-5 md:p-6 rounded-2xl shadow-sm">
        ...
        <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-xl text-sm transition-all active:scale-[0.98]">Send Message</button>
      </form>
    </main>
  );
}
