    ...
    <div className="min-h-screen bg-[#fafbfc] flex items-center justify-center p-4 font-sans selection:bg-[#fcd71a]/30">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-[#eef2f7] p-8 md:p-10 relative">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="flex justify-between items-center pt-1">
            <div className="text-[10px] text-zinc-400 font-mono tracking-wider">
               *Admin: <span className="text-[#cca01d] cursor-help" title="Email: admin@collegeachiver.com | Pass: admin123">Hover for Hint</span>
            </div>
            <Link href="/forgot-password" className="text-xs font-bold text-[#cca01d] hover:text-[#977914] transition-colors">
              Forgot Password?
            </Link>
          </div>
        ...
        <div className="mt-8 text-center text-xs font-semibold text-[#5e6b7f]">
          ...
          <Link href="/register" className="font-extrabold text-[#111625] hover:text-[#cca01d] transition-colors underline decoration-[#fcd71a]/40 decoration-2 underline-offset-4">
            Register now
          </Link>
        </div>
        
        <div className="mt-6 text-center">
            <Link href="/" className="text-[11px] font-bold text-[#8492a6] hover:text-[#111625] transition-colors">
                ← Back to Homepage
            </Link>
        </div>
      </div>
